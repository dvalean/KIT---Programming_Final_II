...
public enum Messages {
    ...
    SELECT_TARGET("Choose Runa's target."),
    ENUMERATION("%d) %s"),
    ...
    NEXT_DICE("2) next palyer dice"),
    DICE_UPGRADE("Runa upgrades her die to a d%d"),
    PICK_CARDS("Pick 2 card(s) as loot"),
    HEALING("Runa %d/%d can discard ability cards for healing (or none)"),
